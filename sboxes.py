...
# Takes in a parameter which is an 8-bit number (either as string or binary or int) and returns the value in that index of the matrix
...
def S1(param8):
    ...
    row = int(BIN_to_DEC(param8[:5]))
    col = int(BIN_to_DEC(param8[5:]))
    return mat[row][col]
